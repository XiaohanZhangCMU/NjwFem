				...
				cudaStream_t stream )
{
    ...
    tex_ref_D.normalized = false;
    tex_ref_D.filterMode = cudaFilterModePoint;
    tex_ref_D.addressMode[0] = cudaAddressModeClamp;
    ...
    assert(cudaBindTexture(&offsetA, tex_ref_A, d_A, sizeA*sizeof(cuDoubleComplex))
	   == cudaSuccess);
    assert(cudaBindTexture(&offsetD, tex_ref_D, d_D, sizeD*sizeof(cuDoubleComplex))
     	   == cudaSuccess);
	...
	GENERATE_SM_VERSION_NAME(gemdm_nn)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
	...
	GENERATE_SM_VERSION_NAME(gemdm_nt)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	GENERATE_SM_VERSION_NAME(gemdm_tn)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	GENERATE_SM_VERSION_NAME(gemdm_tt)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	dim3 dimGrid(m/BLK_M_nt + (m%BLK_M_nt != 0),
		     n/BLK_N_nt + (n%BLK_N_nt != 0));
	GENERATE_SM_VERSION_NAME(gemdm_nc)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb, 
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	dim3 dimGrid(m/BLK_M_tt + (m%BLK_M_tt != 0),
		     n/BLK_N_tt + (n%BLK_N_tt != 0));
	GENERATE_SM_VERSION_NAME(gemdm_tc)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	dim3 dimGrid(m/BLK_M_tn + (m%BLK_M_tn != 0),
		     n/BLK_N_tn + (n%BLK_N_tn != 0));
	GENERATE_SM_VERSION_NAME(gemdm_cn)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	dim3 dimGrid(m/BLK_M_tt + (m%BLK_M_tt != 0),
		     n/BLK_N_tt + (n%BLK_N_tt != 0));
	GENERATE_SM_VERSION_NAME(gemdm_ct)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
	...
	dim3 dimGrid(m/BLK_M_tt + (m%BLK_M_tt != 0),
		     n/BLK_N_tt + (n%BLK_N_tt != 0));
	GENERATE_SM_VERSION_NAME(gemdm_cc)<<< dimGrid, dimBlock, 0, stream >>>(m, n, k, alpha, d_A, lda, d_D, ldd, d_B, ldb,
									       beta, d_C, ldc,
									      (int)offsetA, (int) offsetD, (int)offsetB,
									      blocknbr, blocktab, fblocknbr, fblocktab);
    }
